...
public class FileTest {
	...
	public static void main(String[] args) {
		File file1 = new File("d:\\test\\test-test.txt");//
...
//		System.out.println(dir1.exists());
		...
		File newFile = new File("d:\\test", "test-text2.txt"); // 아래거랑 똑같은 경로임
		File newFile2 = new File(dir2, "test-text2.txt");

		System.out.println("파일 여부확인 : " + newFile.isFile());
		System.out.println("폴더 여부확인 : " + dir2.isDirectory());

		File[] list = dir2.listFiles(); // 배열 선언하고 끝
