...
public class DeptUpdateController {
	...
	public DeptUpdateController() {
		...
		this.updateService = new DeptUpdateService(); //생성자통해서 초기화
	}
...
//		Dept dept = new Dept();
		Dept dept = searchService.searchDept(deptno); //여기서 객체생성을 해주는게 아니라 DeptDao클래스에서 객체생성을 해서 return 값으로 반환해준걸 전달받아서 사용함
		System.out.println("-------------------------------------------");
