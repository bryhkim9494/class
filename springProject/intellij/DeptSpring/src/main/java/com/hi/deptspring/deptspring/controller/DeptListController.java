...
public class DeptListController {
    ...
    public void getListPage(Model model,
                            @RequestParam(value = "searchType", defaultValue = "") String searchType, // 1번째 방법
                            @RequestParam(value = "keyword", defaultValue = "") String keyword,// 1번째 방법
                            DeptSearchOption deptSearchOption // 2번째방법
    ) {
